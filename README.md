...
- 完整音频剪辑工具栏：剪切、复制、粘贴、删除、裁剪、播放头分割、选区复制为新轨、插入外部片段、合并轨道、静音、反转、标准化、淡入与淡出
- 非破坏式多片段时间线：每段音频拥有独立起点、素材入点/出点、音量和速度；支持抓取移动、边缘裁剪、分割、复制、粘贴及统一时钟同步播放/导出
- 撤销/重做与 WAV 导出
...
- 麦克风录音带独立状态窗口、计时与详细权限错误提示，停止后自动解码并加入新音轨
- 轨道和片段支持儿童感、老年感、机器人、女声感、卡通高音、猴王戏曲感、憨厚低音、喜剧男声等通用变声预设
- 轨道与片段支持 -12～+12 半音真正变调；FFmpeg 会补偿时长并保留原音，可随时恢复或重新生成
- 选中立体声音轨后可进行本地快速人声/伴奏分离，自动生成两条可独立处理的新轨道
- 右上视频监看区支持网络媒体直链播放；允许跨域读取的 MP4/WebM/MOV 可提取原声，HLS 可在浏览器原生支持时播放
- 浏览器屏幕录制支持“选择来源 → 预录制预览 → 开始/停止 → 保存视频或导入剪辑”，可选择整个屏幕、窗口或标签页，并支持原始尺寸、720p、1080p
